      ...
      <div className="flex flex-row h-full w-full overflow-x-hidden rounded-xl">
        <div className="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
          <div className="flex flex-col">
            ...
            <div className="flex flex-col space-y-1 mt-4 -mx-2 h-32 overflow-y-scroll">
        ...
        <div className="flex flex-col flex-auto h-full">
          <div className="flex flex-col flex-auto flex-shrink-0 bg-gray-200 dark:bg-gray-900 h-80 p-4 pt-0">
            <div className="py-1 pl-2 bg-white mt-2 rounded-lg">
              {selectCompetition === "all" ? (
            ...
            <div className="flex flex-col h-full overflow-y-auto mb-4">
              <div className="relative flex flex-col h-full">
                ...
                <div className="grid grid-cols-12">
                  {valueMessage &&
                    Object.values(valueMessage).map((value: any, i: number) => {
                      if (value?.uid === user?.uid) {
                        return (
                          <div
                            ...
                            className="col-start-3 col-end-13 pl-3 py-1 rounded-lg"
                          >
                            ...
                            Object.values(valueMessage)[i]?.uid ? (
                              ...
                              <div className="text-xs text-gray-500 text-center pb-2 pt-4">
                                {isDate(new Date(value.createdAt))
            ...
            <form
              ...
              className="relative flex flex-row items-center h-16 rounded-xl bg-white w-full px-4 z-0"
            >
              <div
