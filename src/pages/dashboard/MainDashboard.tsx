...
const MainDashboard: React.FC<Props> = () => {
    ...
    dispatch(
      fetchMatches({
        dateFrom: isMonday(new Date())
          ? Utils.formatWithTimeZone(new Date(), "yyyy-MM-dd")
          : Utils.formatWithTimeZone(previousMonday(new Date()), "yyyy-MM-dd"),
        dateTo: isSunday(new Date())
          ? Utils.formatWithTimeZone(new Date(), "yyyy-MM-dd")
          : Utils.formatWithTimeZone(nextSunday(new Date()), "yyyy-MM-dd"),
      })
    );
    //eslint-disable-next-line
  }, []);
  ...
  return (
    <div className="">
      ...
      >
        <div className="text-xl font-bold py-2 mt-2">Football weekly</div>
            ...
            return (
              ...
              >
                {({ open }) => {
                  return (
                    <>
                      <Disclosure.Button className="flex w-full justify-between bg-gray-200 dark:bg-gray-900 p-2 rounded-lg">
                        <div
                          onClick={() =>
                            navigate(
                      ...
                      >
                        <Disclosure.Panel className="-mt-2 p-2 dark:bg-gray-900 bg-gray-200 rounded-lg">
                          <CMatchNoFilter
                            showLeague={false}
