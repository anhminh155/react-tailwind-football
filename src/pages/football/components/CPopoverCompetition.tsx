            ...
            >
              <Popover.Panel className="absolute left-1/2 z-10 mt-3 w-screen max-w-sm -translate-x-16 -translate-y-10 transform px-4 sm:px-0 lg:max-w-3xl">
                <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                  <div className="relative grid gap-8 bg-white p-7 lg:grid-cols-1 overflow-auto h-[300px]">
                        ...
                        <Link
                          ...
                          to={
                            item.type === EnumTypes.CompetitionType.CUP
                              ? `/dashboard/cup_${item.code}`
                              : `/dashboard/league_${item.code}`
                          }
                          key={i}
                          className="cursor-pointer -m-3 flex items-center rounded-lg p-2 transition duration-150 ease-in-out hover:bg-gray-200 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50"
                        >
                  ...
                  <div className="bg-gray-50 p-4">
                    <span
                      ...
                      className="cursor-pointer flow-root rounded-md px-2 py-2 transition duration-150 ease-in-out hover:bg-gray-200 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50"
                    >
